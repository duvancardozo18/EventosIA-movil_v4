...
import CreateLocationForm from "./createevent/CreateLocationForm"
import CreateTypeEventForm from "./createevent/CreateTypeEventForm"
...
export default function CreateEventScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {showTypeForm && (
        <CreateTypeEventForm onChange={(data) => setTypeEventData(data)} />
      )}
      ...
      {showLocationForm && (
        <CreateLocationForm onChange={(data) => setLocationData(data)} />
      )}
