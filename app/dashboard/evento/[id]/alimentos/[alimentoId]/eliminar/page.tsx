...
export default function AlimentoEliminado({ params }: { params: { id: string; alimentoId: string } }) {
  return (
    <div className="flex flex-col min-h-screen p-6">
      ...
      <div className="flex flex-col items-center justify-center flex-1 text-center">
        <h1 className="text-2xl font-bold mb-2">Alimento Eliminado</h1>
        ...
        <Link href={`/dashboard/evento/${params.id}/alimentos`} className="w-full">
