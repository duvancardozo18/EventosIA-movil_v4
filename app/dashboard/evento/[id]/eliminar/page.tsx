...
export default function EventoEliminado({ params }: { params: { id: string } }) {
  return (
    <div className="flex flex-col min-h-screen p-6">
      <div className="flex items-center mb-6">
        <Link href="/dashboard/mis-eventos" className="text-gray-800">
          <ArrowLeft className="h-6 w-6" />
        </Link>
      </div>

      <div className="flex flex-col items-center justify-center flex-1 text-center">
        <h1 className="text-2xl font-bold mb-2">Evento eliminado</h1>
